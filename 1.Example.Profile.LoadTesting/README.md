...
9.14.Таблица. TOP 5 наиболее медленных методов за ЧПН
...
9.15.Задание. Ответ. Методы в TOPмедленных, но нет в TOPчастых (Задание 4)
...
10.Load testing Profile. Соединим таблицы из пунктов 9.12 и 9.15 (Задание 5)
